          ...
          <div className={`flex-1 min-h-[350px]`}>
            <ResponsiveContainer width="100%" height="100%" minWidth={0} minHeight={0}>
              <AreaChart data={totalProfitCurveData} margin={{ top: 10, right: 50, left: 10, bottom: 10 }}>
                ...
                <Tooltip contentStyle={{ backgroundColor: 'hsl(var(--bkg))', borderRadius: '16px', border: '1px solid hsl(var(--border))', fontSize: '12px', fontWeight: 'bold' }} formatter={(value: number) => [`${currencySymbol}${value.toLocaleString()}`, 'Profit']} />
                <Area type="monotone" dataKey="profit" stroke={`hsl(var(--success))`} fill={`url(#colorProfit)`} strokeWidth={3} activeDot={{ r: 6, strokeWidth: 0, fill: 'hsl(var(--success))' }} connectNulls />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
