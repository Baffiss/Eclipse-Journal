...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    strategyLogicPlaceholder: `What is the logic behind this strategy?`,
  ...
  es: {
    ...
    strategyLogic: `Lógica de la Estrategia`,
    strategyLogicPlaceholder: `¿Cuál es la lógica detrás de esta estrategia?`,
    editWatchlist: `Editar Lista de Seguimiento`,
    setups: `Setups`,
    addSetup: `Añadir Setup`,
    selectSetup: `Seleccionar Setup`,
    setup: `Setup`,
    setupPerformance: `Rendimiento de Setup`,
